...
// IterCb Iterator callbacalled for every key,value found in maps.
// RLock is held for all calls for a given shard therefore callback
// sess consistent view of a shard, but not across the shards.
